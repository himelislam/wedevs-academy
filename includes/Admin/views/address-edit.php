<div class="wrap">
    <h1><?php _e( 'Edit Address Book', 'wedevs-academy') ?></h1>
        ...
        <table>
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <textarea name="address" id="address" cols="30" rows="10" class="regular-text"><?php echo esc_textarea( $address->address ); ?></textarea>
                    </td>
                </tr>
